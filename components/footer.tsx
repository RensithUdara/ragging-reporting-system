      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4 animate-fade-in-up">
            <h3 className="text-xl font-bold">SafeCampus</h3>
            <p className="text-gray-300 dark:text-gray-400">Making Sri Lankan universities safer for everyone.</p>
          </div>
          <div className="animate-fade-in-up animation-delay-100">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/report" className="text-gray-300 dark:text-gray-400 hover:text-white transition-colors">
                  Report Incident
                </Link>
              </li>
              <li>
          ...
          <div className="animate-fade-in-up animation-delay-300">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-gray-300 dark:text-gray-400 hover:text-white transition-colors transform hover:scale-110"
              >
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center animate-fade-in-up animation-delay-400">
          <p className="text-gray-400">© 2025 CodeCraftix Technologies</p>
        </div>
      </div>
    </footer>
  )
